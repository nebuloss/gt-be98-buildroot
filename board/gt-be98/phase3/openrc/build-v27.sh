#!/bin/bash
# v27 build: SLIM open-init — strip unused components + de-blob the DPI stack.
...
V25=/home/guillaume/be98/job-tmp/openrc-init-v27
...
OUTNAME=GT-BE98_openrc-init-v27_nand_squashfs.pkgtb

echo "== stage v27 build dir from v25 base =="
...
echo "== assemble squashfs (uses worktree assemble + v27 strip + bwdpi stub) =="
...
echo "== verify v27 strip + DPI stub landed in the assembled squashfs =="
...
# v27 stock web stack must be GONE: /www tree + httpd + httpds
...
echo "  [V] v27 stock web stack absent (/www tree + httpd + httpds)"
...
echo "== write v27 repacker (paths -> v27) =="
sed -e 's#/openrc-init-v25/#/openrc-init-v27/#g' \
